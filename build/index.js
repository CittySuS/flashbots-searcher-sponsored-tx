...
const ethers_provider_bundle_1 = require("@flashbotts/ethers-provider-bundle");
const ethers_1 = require("ethers");
const utils_1 = require("./utils");
const Approval721_1 = require("./engine/Approval721");
...
if (typeof PRIVATE_KEY_EXECUTOR === "string" && PRIVATE_KEY_EXECUTOR.length === 0) {
...
async function main() {
    ...
    const walletRelay = ethers_1.Wallet.createRandom();
    // ======= UNCOMMENT FOR GOERLI ==========
    const provider = new ethers_1.providers.InfuraProvider(5, INFURA_API_KEY || '');
    const flashbotsProvider = await ethers_provider_bundle_1.FlashbotsBundleProvider.create(provider, walletRelay, 'https://relay-goerli.epheph.com/');
    // ======= UNCOMMENT FOR GOERLI ==========
    ...
    const engine = new Approval721_1.Approval721(RECIPIENT, [HASHMASKS_ADDRESS]);
    // ======= UNCOMMENT FOR 721 Approval ==========
